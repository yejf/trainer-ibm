...
@Configuration
@ComponentScan({"com.kclmedu.mvc.dao.impl","com.kclmedu.mvc.service.impl"})
@PropertySource("classpath:db.properties")
@EnableAspectJAutoProxy  //启动AOP
@EnableTransactionManagement //启动基于注解的 声明式事务
@MapperScan(value = "com.kclmedu.mvc.mapper")  //自动扫描
public class AppConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean(@Autowired DataSource dataSource) {
        ...
        //设置 实体的别名
        factoryBean.setTypeAliasesPackage("com.kclmedu.mvc.entity");
        //返回
        return factoryBean;
    }
